<template>
  <div class="flex font-mono justify-center font-bold text-4xl mt-20">
    Top <span class="store-text ml-2"> Store </span>
  </div>

  <div
    class="flex justify-center items-center space-x-4 lg:mt-10 md:mt-4 mt-10 mb-20"
  >
    <button
      style="
        z-index: 4;
